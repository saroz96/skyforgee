            ...
            switch (e.key) {
                ...
                case 'Enter':
                    if (selectedRowIndex >= 0 && selectedRowIndex < filteredBills.length) {
                        navigate(`/purchase-return/${filteredBills[selectedRowIndex]._id}/print`);
                    }
                    break;
                default:
                    break;
                                                ...
                                                <td className='compact-cell'>
                                                    <div className="d-flex gap-2">
                                                        <button
                                                            ...
                                                            onClick={() => navigate(`/api/retailer/purchase-return/${bill._id}/print`)}
                                                        >
                                                            <i className="fas fa-eye"></i>View
                                                        </button>
                                                        <button
                                                            className="btn btn-sm btn-warning"
                                                            onClick={() => navigate(`/purchase-return/edit/${bill._id}`)}
                                                        >
