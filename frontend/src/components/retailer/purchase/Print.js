            ...
            <div className="screen-version">
                <Container>
                    <div className="d-flex justify-content-end mb-3">
                        <Button variant="secondary" className="me-2" href={'/api/retailer/purchase-register'}>
                            <BiArrowBack /> Back
                        </Button>
                            ...
                            <tbody>
                                {billData.bill.items.map((item, i) => (
                                    <tr key={i}>
                                        ...
                                        <td>{item.Altbonus}</td>
                                        <td>{item.AltpuPrice.toFixed(2)}</td>
                                        <td>{item.mrp.toFixed(2)}</td>
                                        <td>{item.marginPercentage}</td>
                                        <td>{(item.Altquantity * item.AltpuPrice).toFixed(2)}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </Table>
                            ...
                            <table className="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-right">{billData.bill.totalCCAmount.toFixed(2)}</td>
                                    </tr>
                ...
                <div className="print-invoice-container">
                    ...
                    <table className="print-totals-table">
                        <tbody>
                            ...
                            <tr>
                                <td><strong>CC Charge:</strong></td>
                                <td className="print-text-right">{billData.bill.totalCCAmount.toFixed(2)}</td>
                            </tr>
                            {!billData.bill.isVatExempt && (
                                <>
                                    <tr>
