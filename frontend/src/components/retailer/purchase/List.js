            ...
            switch (e.key) {
                ...
                case 'Enter':
                    if (selectedRowIndex >= 0 && selectedRowIndex < filteredBills.length) {
                        navigate(`/api/retailer/purchase/${filteredBills[selectedRowIndex]._id}/print`);
                    }
                    break;
                default:
                    break;
                    ...
                    <div className="row mb-4">
                        ...
                        <div className="col-md-4 d-flex align-items-end justify-content-end gap-2">
                            <button
                                ...
                                onClick={() => navigate('/api/retailer/purchase')}
                            >
                                                ...
                                                <td className='compact-cell'>
                                                    <div className="d-flex gap-2">
                                                        <button
                                                            ...
                                                            onClick={() => navigate(`/api/retailer/purchase/${bill._id}/print`)}
                                                        >
                                                            <i className="fas fa-eye"></i>View
                                                        </button>
                                                        <button
                                                            className="btn btn-sm btn-warning"
                                                            onClick={() => navigate(`/api/retailer/purchase/edit/${bill._id}`)}
                                                        >
