                    ...
                    <Card>
                        ...
                        <div className="voucher-header">
                            ...
                            <div className="invoice-details">
                                ...
                                <p><strong>Date:</strong> {new Date(receiptData.receipt.date).toLocaleDateString()}</p>
                            </div>
                        </div>
                        ...
                        <Table className="voucher-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        {receiptData.receipt.isActive ?
                                            receiptData.receipt.credit?.toFixed(2) :
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th>{receiptData.receipt.credit?.toFixed(2)}</th>
                                    <th>{receiptData.receipt.credit?.toFixed(2)}</th>
                                </tr>
                            </tfoot>
                        </Table>
