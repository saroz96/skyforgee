            ...
            switch (e.key) {
                ...
                case 'Enter':
                    if (selectedRowIndex >= 0 && selectedRowIndex < filteredBills.length) {
                        navigate(`/bills/${filteredBills[selectedRowIndex]._id}/print`);
                    }
                    break;
                default:
                    break;
                    ...
                    <div className="row mb-4">
                        ...
                        <div className="col-md-4 d-flex align-items-end justify-content-end gap-2">
                            <button
                                ...
                                onClick={() => navigate('/api/retailer/bills')}
                            >
                                                ...
                                                <td className='compact-cell'>
                                                    <div className="d-flex gap-2">
                                                        <button
                                                            ...
                                                            onClick={() => navigate(`/api/retailer/sales/${bill._id}/print`)}
                                                        >
                                                        ...
                                                        {bill.account?._id ? (
                                                            <button
                                                                ...
                                                                onClick={() => navigate(`/api/retailer/bills/edit/${bill._id}`)}
                                                            >
                                                            ...
                                                            <button
                                                                className="btn btn-sm btn-warning"
                                                                onClick={() => navigate(`/api/retailer/bills/editCashAccount/${bill._id}`)}
                                                            >
                                                                <i className="fas fa-edit"></i>Edit
                                                            </button>
                                                        ) : null}
