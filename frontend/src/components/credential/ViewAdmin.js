            ...
            <div className="col-lg-8">
              <div className="card shadow-sm border-0">
                ...
                <div className="card-body p-4">
                  ...
                  <div className="mb-4">
                    <h5><FaInfoCircle className="me-2" /> Additional Info</h5>
                    <p className="text-muted">
                      <small>Last Login: {user.lastLogin ? new Date(user.lastLogin).toLocaleString() : 'Never'}</small>
                    </p>
                    <p className="text-muted">
                ...
                {currentUser?.isAdminOrSupervisor && !user.isOwner && (
                  <div className="card-footer text-end">
                    <Link to="/admin/users/list" className="btn btn-outline-primary">
